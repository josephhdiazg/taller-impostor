...
public class RoomServiceImpl implements RoomService {
    ...
    @Override
    public RoomShowResponse findByCode(String code) {
    ...
    @Override
    public RoomCreateResponse create(RoomCreateRequest dto) {
    ...
    private RoomShowResponse toDto(RoomEntity r) {
        List<PlayerListResponse> players = playerRepo.findAll().stream()
                ...
                .toList();
        return new RoomShowResponse(r.getStatus().getLabel(), r.getCategory().getLabel(), r.getCurrentRound(), players);
    }
    ...
    private RoomEntity toEntity(RoomCreateRequest dto) {
